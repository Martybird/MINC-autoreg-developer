...
/* New code for extracting angles from matrix supporting the full trigonometric circle through atan2. */
...
#if 0 // Old code for angles extraction from matrix that is limited to +/- pi/2
VIO_BOOL rotmat_to_ang(float **rot, float *ang)
{
